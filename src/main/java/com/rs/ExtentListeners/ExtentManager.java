package com.rs.ExtentListeners;
...
public class ExtentManager {
    ...
    public synchronized static ExtentReports getReporter() {
        if (extent == null) {
	        ...
	        extent.setSystemInfo("Automation Tester", "Mahomed Sader");
	        extent.setSystemInfo("Organization", "RS Components");
	        extent.setSystemInfo("Build no", "RSC-0001");
        }
        return extent;
    }
